...
def get_pre_cookie():
    exist_eles = driver.find_elements(By.CSS_SELECTOR, "#__next > div > div.login_login_container__m0zeS > div.login_login_item__0Mprr.login_login_btn__nY2rY.login_login_btn_feishu__K3tFP > a")
    try:
        # 打开网页
